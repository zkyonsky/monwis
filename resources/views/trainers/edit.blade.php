            ...
            <div class="row">
                <div class="col-md-12">     
                    ...
                    <div class="card-header">
                        <h3 class="card-title">Edit Widyaiswara/Pengajar</h3>
                    ...
                    <div class="card-body">
                        <div class="form-group">
                            ...
                            <input id="full_name" name="full_name" value="{{ old('full_name', $trainer->full_name) }}" type="text" 
                        ...
                        <div class="form-group">
                            <label>NIP</label>
                            <input id="nip" name="nip" value="{{ old('nip', $trainer->nip) }}" type="text" 
                        ...
                        <div class="form-group">
                            ...
                            <select id="panggol" name="panggol" class="form-control custom-select @error('panggol') is-invalid @enderror" >
                                <option value='{{ $trainer->panggol }}' selected>{{ $trainer->panggol }}</option>
                        ...
                        <div class="form-group">
                            ...
                            <select id="unit" name="unit" class="form-control custom-select @error('unit') is-invalid @enderror" >
                                <option value='{{ $trainer->unit }}' selected>{{ $trainer->unit }}</option>
                                <option value='Pusdiklat Pajak'>Pusdiklat Pajak</option>
                        ...
                        <div class="form-group clearfix">
                            ...
                            <div class="icheck-success">
                                <input type="radio" name="status" id="widyaiswara" value="Widyaiswara"
                                    @if ($trainer->status == 'Widyaiswara') checked @endif
                                >
                            ...
                            <div class="icheck-success">
                                <input type="radio" name="status" id="pengajar_bppk" value="Pengajar BPPK"
                                    @if ($trainer->status == 'Pengajar BPPK') checked @endif
                                >
                            ...
                            <div class="icheck-success">
                                <input type="radio" name="status" id="pengajar_non_bppk" value="Pengajar Non-BPPK"
                                    @if ($trainer->status == 'Pengajar Non-BPPK') checked @endif
                                >
                        ...
                        <div id="jabatan_wi" class="collapse">
                            ...
                            <select name="jabatan_wi" class="form-control custom-select @error('jabatan_wi') is-invalid @enderror">
                                ...
                                @if ($trainer->status == 'Widyaiswara')
                                <option selected>{{ $trainer->jabatan }}</option>
                                @endif
                        ...
                        <div id="jabatan_non_wi" class="collapse">
                            <label>JABATAN</label>
                            <input name="jabatan_non_wi" value="@if ($trainer->status !== 'Widyaiswara') {{ $trainer->jabatan }} @endif" type="text" 
                    ...
                    <div class="card-footer">
                        <input type="submit" value="Edit Pengajar" class="btn btn-success">
                    </div>
                    <!-- /.card -->
                </div>
            </div>
  ...
  @push('scripts')
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            var status = '<?php echo($trainer->status);?>';
            if(status == 'Widyaiswara') {
            ...
            $("#pengajar_bppk").click(function(){
                $("#jabatan_non_wi").collapse('show');
                $("#jabatan_wi").find('select option:eq(0)').prop('selected', true);
